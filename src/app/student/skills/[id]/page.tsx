                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3.5 bg-emerald-50 rounded-2xl border border-emerald-200 text-xs text-emerald-800 text-left space-y-1">
                    ...
                    <p className="text-slate-600">
                      Your verified {skill.name} skill increased your local internship match score from <strong>62% to 87%</strong>! This badge is now live on your Resume and Student Profile.
                    </p>
                  </div>
